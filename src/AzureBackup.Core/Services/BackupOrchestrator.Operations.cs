...
public partial class BackupOrchestrator
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        Metrics?.RecordOperationAndFlush(new OperationMetrics
        {
            ...
            ThroughputMBps = ThroughputMetrics.ComputeThroughputMBps(result.BytesTransferred, mirrorElapsed),
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        Metrics?.RecordOperationAndFlush(new OperationMetrics
        {
            ...
            ThroughputMBps = ThroughputMetrics.ComputeThroughputMBps(processedBytes, opElapsed),
            FileConcurrency = effectiveFileConcurrency,
